                        ...
                        <div class="form-horizontal form-bordered">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="txtnomb_inmueble" name="txtnomb_inmueble" required pattern="[A-Za-z0-9]+" class="form-control" placeholder="Ingresar nombre.." value="<?= $nombre ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="product-short">Numero de pisos: </label>
                                    <div class="col-md-9">
                                        <input type="text" id="txtpisos" name="txtnumpisos" required pattern="[0-9]+" class="form-control" placeholder="Ingresar numero.." value="<?= $piso ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="product-short-name">Direccion: </label>
                                    <div class="col-md-9">
                                        <textarea id="Direccion" name="txtdireccion" required pattern="[A-Za-z0-9]+" class="form-control" placeholder="Escriba Direccion.." rows="3"><?= $direccion ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            <input type="text" id="txtnumdirec" name="txtnumdirec" required class="form-control" placeholder="Ingresar Cantidad" value="<?= $numdireccion ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            <input type="text" id="txtnumhab" name="txtnumhab" required pattern="[0-9]+" class="form-control" placeholder="Ingresar Cantidad" value="<?= $numhabitaciones ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            <input type="text" id="txtnumbañ" name="txtnumbañ" required pattern="[0-9]+" class="form-control" placeholder="Ingresar Cantidad" value="<?= $numbaños ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            <input type="text" id="txtmetros" name="txtmetros" required pattern="[0-9]+" class="form-control" placeholder="Ingresar Cantidad" value="<?= $metrosc ?>">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            <input type="text" id="txtprecio" name="txtprecio" required pattern="[0-9]+" class="form-control" placeholder="Ingresar Cantidad" value="<?= $precio ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea id="Descripcion" name="txtdescripcion" required pattern="[A-Za-z0-9]+" class="form-control" placeholder="Escriba Direccion.." rows="7"> <?= $descrip ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea id="txtservicios" name="txtservicios" required pattern="[A-Za-z0-9]+" class="form-control" placeholder="Escriba descripcion.." rows="3"><?= $servicios ?></textarea>
                                    </div>
                                </div>
