                ...
                <form action="grabar_arrendatario" method="POST">
                    ...
                    <div class="form-horizontal form-bordered">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="product-name" name="txtnombre" required pattern="[a-zA-Z0-9àáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ]{2,48}" placeholder="minimo 2 caracteres" class="form-control" value=" <?= $nomb_visitante ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">Apellidos</label>
                            <div class="col-md-9">
                                <input type="text" id="product-name" name="txtapellido" required pattern="[a-zA-Z0-9àáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ]{2,48}" placeholder="minimo 2 caracteres" class="form-control" value=" <?= $ape_visitante ?>">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="product-name" name="txtdni" required pattern="[0-9]{8,12}" placeholder="min 8 max 12 digitos" class="form-control" value=" <?= $nro_documento ?>">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="product-name" name="txtcel" required pattern="[0-9]{9,11}" placeholder="min 9 max 11 digitos" class="form-control" value="<?= $telefono ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">Direccion</label>
                            <div class="col-md-9">
                                <input type="text" id="product-name" name="txtdireccion" required pattern="[a-zA-Z0-9àáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}" placeholder="minimo 2 caracteres" class="form-control" value="<?= $direccionper ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">Email</label>
                            <div class="col-md-9">
                                <input type="text" id="product-name" name="txtemail" placeholder="ingrese correo" pattern="^[a-zA-Z0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$" required class="form-control" value="<?= $correo ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">Nombre de Usuario</label>
                            <div class="col-md-9">
                                <input type="text" id="product-name" name="txtusu" class="form-control" pattern="^([a-zA-Z]+[0-9]{0,2}){5,12}$" required placeholder="min 5 max 12 digitos" value="<?= $nomb_usu ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">Contraseña</label>
                            <div class="col-md-9">
                                <input type="text" id="product-name" pattern="[A-Za-z0-9]{8,12}" required name="txtpass" class="form-control" placeholder="min 8 max 12 digitos" value="<?= $pass_usu ?>">
                            </div>
                        </div>
